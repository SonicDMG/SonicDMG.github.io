...
date: "2018-01-10"
excerpt: "Hi there and welcome to part 1 of a three part series on upgrading our KillrVideo java reference application from Cassandra based tabular searches to using DSE Search."
category: "Technical"
...
![videodetail](/posts/moving-from-cassandra-to-search-part-1/videodetail.png)
...
![typeahead](/posts/moving-from-cassandra-to-search-part-1/typeahead.png)
...
![tag](/posts/moving-from-cassandra-to-search-part-1/tag.png)
...
![more videos like this](/posts/moving-from-cassandra-to-search-part-1/morelikethis.png)

### Let's take a look at the implementation

Remember I mentioned **before moving** to using DSE Search these were all powered with Cassandra tables. Let's break some of this down and take a look at some details. Also, if you are interested check out this [pull request](https://github.com/KillrVideo/killrvideo-java/pull/23/files) up on github. You can use this as a reference of the before and after changes if you so choose.

#### Overview

So overall the setup is pretty simple. We have 3 searches that are supported by a combination of 3 Cassandra tables (the number of searches and tables just happen to match, there is no correlation between them), 3 [table entities](https://docs.datastax.com/en/developer/java-driver-dse/1.4/manual/object_mapper/creating/) that map to our Cassandra tables, and 3 [mapping objects](https://docs.datastax.com/en/developer/java-driver-dse/1.4/manual/object_mapper/using/) derived from our table entities. Here is a simple visual representation.

![overview](/posts/moving-from-cassandra-to-search-part-1/overviewarch.png)
...
![tags_by_letter query example](/posts/moving-from-cassandra-to-search-part-1/tagsbyletterexample.png)
