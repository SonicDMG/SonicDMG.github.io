...
(_As of this writing, OpenRAG is new open source development in open preview on_ [_version 0.4.0_](https://github.com/langflow-ai/openrag/releases)_. We'd_ [_love your feedback or help contributing_](https://docs.openr.ag/support/contribute/) _to OpenRAG to make it even better.)_
...
I was inspired recently to write this app after watching Tejas Kumar's video ["Unlocking Video Knowledge with Docling: Transcribe & Query with AI"](https://youtu.be/AXrmMo3GzT0?si=wphEKfr1dpNOFrwQ) that demonstrated how to expose **Docling**'s audio ingestion capabilities in less than 30 lines of code. The moment I watched it, I was like "OMG, I can use this for my video content!". So here we are.

(_Tejas's [original video](https://youtu.be/AXrmMo3GzT0?si=wphEKfr1dpNOFrwQ) uses mp3 which can also work for videos, but while coding I learned that Docling also handles video formats like mp4 so I switched gears to interface with videos directly instead of converting them to audio._)
...
(_As of this writing, OpenRAG is new open source developlment in open preview on_ [_version 0.4.0_](https://github.com/langflow-ai/openrag/releases)_. We'd_ [_love your feedback or help contributing_](https://docs.openr.ag/support/contribute/) _to OpenRAG to make it even better._)